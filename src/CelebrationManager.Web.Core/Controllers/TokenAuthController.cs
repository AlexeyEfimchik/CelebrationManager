...
using Abp.UI;
using CelebrationManager.Authentication.External;
using CelebrationManager.Authentication.JwtBearer;
...
namespace CelebrationManager.Controllers
{
    ...
    public class TokenAuthController : CelebrationManagerControllerBase
    {
