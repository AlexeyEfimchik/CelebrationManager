...
{
    public abstract class CelebrationManagerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CelebrationManagerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CelebrationManagerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CelebrationManagerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CelebrationManagerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CelebrationManagerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CelebrationManagerDbContext, Task<T>> func)
        {
            T result;
